...
$current_year = "2015";//date("Y",strtotime($month_to_traite)); //'2013';
$current_month = "01";//date("m",strtotime($month_to_traite)); //'03';

$start_year = "2014";//date("Y",strtotime($month_debut)); //'2013';
$start_month = "02";//date("m",strtotime($month_debut)); //'03';
...
$first_lundi_final = strtotime('2014-01-27');
$last_lundi_final = strtotime('2015-02-02');
...
$tab_csv["1"] = $strMedecins;//getPropertyValue("FicheCabinet:nom_complet");
...
$tab_csv["81"] = $tab_cabinet['total_cogni']; 
  ...
  // entete
$tab_entete = array();
if(!file_exists('./csv/'.$current_year.'_'.$current_month.'_rhone.csv'))
{
  // activité
...
// Evolution tension
  ...
  $fp = fopen('./csv/'.$current_year.'_'.$current_month.'_poitou_manquant_2014.csv', 'a+');
