...
class DemandeRibStatus
{
    ...
    public function getStatuses()
    {
        ...
        $query = "select * from demande_rib_status";
        try
        {
    ...
    {
        $sql = "INSERT INTO demande_rib_status (intitule, dcreat) 
