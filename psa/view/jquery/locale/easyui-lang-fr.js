...
if ($.fn.validatebox){
	...
	$.fn.validatebox.defaults.rules.email.message = "Veuillez entrer une adresse email valide.";
	$.fn.validatebox.defaults.rules.url.message = "Veuillez entrer une URL valide.";
	$.fn.validatebox.defaults.rules.length.message = "Veuillez entrer une valeur comprise entre {0} et {1}.";
}
if ($.fn.numberbox){
