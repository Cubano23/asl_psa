...
if ($.fn.datagrid){
	$.fn.datagrid.defaults.loadMsg = "Traitement, veuillez patienter ...";
}
...
if ($.fn.validatebox){
  $.fn.validatebox.defaults.missingMessage = 'Ce champ est obligatoire.';
	$.fn.validatebox.defaults.rules.email.message = "Merci d'entrer une adresse email valide.";
	$.fn.validatebox.defaults.rules.url.message = "Merci d'entrer une URL valide.";
	$.fn.validatebox.defaults.rules.length.message = "Merci d'entrer une valeur comprise entre {0} et {1}.";
}
if ($.fn.calendar){
