<?php
$startdate= isset($_REQUEST['startdate'])?$_REQUEST['startdate']:'2013';
$startdate2=$startdate-1;
//error_log($startdate.' '.$startdate2);
...
while(list($cab, $id,$numero, $dsuivi) = mysql_fetch_row($res))
{
    ...
    if((isset($regions[$cab]))&&($sortie!=1)&&($ADO!="")&&($ADO!="aucun")&&($dsuivi<=$d1an))
    {
        ...
        $req="SELECT  count(*) ".
            "FROM liste_exam ".
            "WHERE  date_exam >='$startdate-01-01' ".
            "and type_exam='HBA1c' ".
            "and id='$id' ".
        ...
        $req="SELECT  count(*) ".
            "FROM liste_exam ".
            "WHERE date_exam > '$startdate2-01-01' ".
            "and type_exam='fond' ".
            "and id='$id' ".
            "GROUP BY id, date_exam";
        $res2=mysql_query($req) or die("erreur SQL:".mysql_error()."<br>$req");
...
while(list($cab, $id,$numero) = mysql_fetch_row($res)) {
    ...
    if((isset($regions[$cab]))&&($sortie!=1)){
        ...
        $req="SELECT date_exam, resultat1 ".
            "FROM liste_exam ".
            "WHERE  type_exam='systole' and date_exam > '$startdate-01-01' ".
            "and id='$id' ".
            "order BY date_exam DESC limit 0,1";
