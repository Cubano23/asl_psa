  ...
  <table border='1' width='700'>
  	<tr>
  		<td width='300' height='50'><font  style=" border-bottom:solid  ; border-color:green ;" >Tabagisme</font></Td>
			...
			<?php radioButton("id='tabac_oui' $color","sevragetabac:tabac","oui"); ?>Oui &nbsp;
			<?php radioButton("id='tabac_non' $color","sevragetabac:tabac","non"); ?>Non &nbsp;
			<?php radioButton("id='tabac_nsp' $color","sevragetabac:tabac","nsp"); ?>Nsp</font>&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
	<td valign="top"><b><a class="fa fa-file-pdf-o fa-2x" aria-hidden="true" href="../view/sevragetabac/docs/Test_Fagerstrom.pdf" target="_blank" title="Télécharger le Test"></a> Test de Fagerstrom</b>
...
<tr>
	<td valign="top"><b><a class="fa fa-file-pdf-o fa-2x" aria-hidden="true" href="../view/sevragetabac/docs/Test_Horn.pdf" target="_blank" title="Télécharger le Test"></a> Test de Horn</a></b><br>(Score de 3 à 15)</td>
	<td>
		<table>
...
<tr>
	<td valign="top"><b><a class="fa fa-file-pdf-o fa-2x" aria-hidden="true" href="../view/sevragetabac/docs/Test_HAD.pdf" target="_blank" title="Télécharger le Test"></a> Test HAD</a></b><br>(Note de 0 à 21)</td>
	<td>
    <table>
...
<table border='1' width='700' cellpadding="10">
  <tr>
  <td valign="top"><a href="../view/sevragetabac/docs/Echelle_evaluation_sentiment_efficacite.pdf" target="_blank" class="fa fa-file-pdf-o fa-2x" title="Télécharger le support"></a> Sentiment d'efficacité <br>(Echelle de 0 à 10)</td>
  <td>
      <?php text("id='echelle_analogique' size='10' maxlength='6'","sevragetabac:echelle_analogique");?>
  </td>
</tr>
 <tr>
  <td valign="top"><a href="../view/sevragetabac/docs/Echelle_evaluation_motivation.pdf" target="_blank" class="fa fa-file-pdf-o fa-2x"></a> Importance du projet <br>(Echelle de 0 à 10)</td>
  <td>
  ...
  <td>
      <?php selectv("","sevragetabac:stade_motivationnel",$stade_motivationnel); ?>
  </td>
</tr>
