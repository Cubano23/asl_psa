...
<table border='0' width='100%' align='center'> 
  <tr> 
    ...
    <td> <table border='1' cellpadding='3'> 
        ...
        <tr <?php echo($depistageCancerColon->ant_pere_type[0] == "aucun"?"style='display:none'":""); ?> >
        ...
        <tr <?php echo($depistageCancerColon->ant_mere_type[0] == "aucun"?"style='display:none'":""); ?> >
        ...
        <tr <?php echo($depistageCancerColon->ant_fratrie_type[0] == "aucun"?"style='display:none'":""); ?>>
        ...
        <tr <?php echo($depistageCancerColon->ant_enfants_type[0] == "aucun"?"style='display:none'":""); ?>>
		...
		<tr <?php echo($depistageCancerColon->colos_polypes == ""?"style='display:none'":""); ?> >
			...
			<td><?php echo($depistageCancerColon->colos_polypes);?></td>
		</tr>
