...
<?php $hypolemiantArray = array(""=>"","Atorvastatine"=>"Atorvastatine",
...
<?php require("view/common/dossierresume.php");?>
			...
			<table>
				...
				<tr>
					...
					<td rowspan='2' style='border:1px solid #919191;padding:5px;'>
						VEMS/CVF<br/>
						<p><b><?php echo round(($CardioVasculaireDepart->spirometrie_VEMS/$CardioVasculaireDepart->spirometrie_CVF), 2);?></b> %</p>
					</td>
				</tr>
				<tr>
					<td>VEMS &nbsp;</td>
  ...
  <table border='1' width='670'>
	...
	<tr>
		...
		<td colspan='2'><?php echo $CardioVasculaireDepart->alcool; ?></td>
	</tr>
	</table>
	<br>
  <b>Bilan lipidique</b>
 ...
 <table border="0">
   <tr>
     ...
     <td> <?php customSubmit("value='Modifier ce suivi'",ACTION_FIND,array(PARAM_EDIT),$param->controler); ?></td>
   </tr>
 </table>
