...
?>
	...
	if((document.getElementById("syst").value!='')||(document.getElementById('dias').value!='')||(document.getElementById("dTA").value!='')
		||(document.getElementById("Ta_modeMan").checked)||(document.getElementById("TA_modeAuto").checked)
			||(document.getElementById("TA_modeMesure").checked)){
<?php
...
?>
		...
		if((!document.getElementById("TA_modeMan").checked)&&(!document.getElementById("TA_modeAuto").checked)
			&&(!document.getElementById("TA_modeMesure").checked)){
  ...
  <table border='1' width='700'>
	<tr>
		<td width='300'>Glycémie</td>
			  ...
			  ?>
			<td><?php text("id='glycemie' size='4' $color onkeyup='remplacevirgule2(\"glycemie\")' maxlength='4'","CardioVasculaireDepart:glycemie");?>g/l &nbsp; le 
...
<br>
	...
	<tr>
		<td width='300'><?php checkBox("id='objectif_poids' ","PremiereConsultCardio:objectif_poids","1");?>
			Poids <img OnClick="javascript:window.open('objectif_poids.html','','width=250,height=250,top=100,left=500,scrollbars=yes,resizable=yes')" alt="Détail de l'objectif" border=0 height="31" src='<?php echo "$path/view/"?>images/loupe.gif' width="31"></Td>
	...
	<tr>
		<td width='300'><?php checkBox("id='objectif_alcool' ","PremiereConsultCardio:objectif_alcool","1");?>
			Alcool <img OnClick="javascript:window.open('objectif_alcool.html','','width=250,height=250,top=100,left=500,scrollbars=yes,resizable=yes')" alt="Détail de l'objectif" border=0 height="31" src='<?php echo "$path/view/"?>images/loupe.gif' width="31">
		</td>
	...
	<tr>
		<td width='300'><?php checkBox("id='objectif_tabac' ","PremiereConsultCardio:objectif_tabac","1");?>
			Tabac <img OnClick="javascript:window.open('objectif_tabac.html','','width=250,height=250,top=100,left=500,scrollbars=yes,resizable=yes')" alt="Détail de l'objectif" border=0 height="31" src='<?php echo "$path/view/"?>images/loupe.gif' width="31">
		</Td>
	...
	<tr>
		<td width='300'><?php checkBox("id='objectif_tension' ","PremiereConsultCardio:objectif_tension","1");?>
			Tension <img OnClick="javascript:window.open('objectif_tension.html','','width=250,height=250,top=100,left=500,scrollbars=yes,resizable=yes')" alt="Détail de l'objectif" border=0 height="31" src='<?php echo "$path/view/"?>images/loupe.gif' width="31">
		</td>
  ...
  <table width='850' border="1" cellpadding='3'>
	...
	Outil(s), support (s), méthodes  utilisés </div>
      ...
      <td  width='70%'><?php textArea("rows=\"8\" cols=\"60\"","EvaluationInfirmier:points_positifs"); ?></td>
    </tr>
    <tr>
	...
	Méthodes envisagées prochaine séance</div>
      ...
      <td  width='70%'><?php textArea("rows=\"8\" cols=\"60\"","EvaluationInfirmier:points_ameliorations"); ?></td>
    </tr>
  </table>
