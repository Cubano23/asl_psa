...
Cette page résume les premières valeurs du dossier. Pour modifier ces valeurs, choisissez les formulaires AVEC ou SANS alertes.
<br><br>
<?php require("view/common/dossierresume.php");?>
  ...
  <table border='1' width='670'>
	<tr>
		<td width='300' height='50'>Tabagisme</font><img OnClick="javascript:window.open('<?php echo "$path/view/cardiovasculaire/"?>tabac.html','','width=350,height=200,top=100,left=500,scrollbars=yes,resizable=yes')" alt='Tabac' border=0 height="31" src='<?php echo "$path/view/"?>images/loupe.gif' width="31"></Td>
		  <?php
			...
			<table>
				...
				<tr>
					...
					<td rowspan='2' style='border:1px solid #919191;padding:5px;'>
						VEMS/CVF<br/>
						<p><b><?php echo $CardioVasculaireDepart->spirometrie_rapport_VEMS_CVF*100;?></b> %</p>
					</td>
				</tr>
  ...
  <table border='1' width='700'>
	...
	<br>
	<?php if($CardioVasculaireDepart->spirometrie_rapport_VEMS_CVF):?>
	 	<input name="button" type="button"  onclick="window.open('<?php echo getLink("$path/controler/ActionControler.php","CardioVasculaireDepartControler",ACTION_LIST,array(PARAM_SPIRO)); ?>', '_top')" value="Retour à la liste des dossiers"/>
	<?php else:?>
	    <input name="button" type="button"  onclick="window.open('<?php echo getLink("$path/controler/ActionControler.php","CardioVasculaireDepartControler",ACTION_LIST,array(PARAM_DEPART)); ?>', '_top')" value="Retour à la liste des dossiers"/>
	<?php endif;?>
