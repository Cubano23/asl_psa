...
<?php
	...
	$js->dateInRange("depistageCancerUterus:date","Date du dépistage");
	$js->endCheckFunction();	
?>
</script>
...
<?php hiddenParam1(PARAM_EDIT); ?>
 ...
 Ce formulaire permet à tout instant de collecter des données utiles au protocole dépistage du cancer du col de l'utérus.<br><br>
Il s'appuie sur les données les plus récentes du patient (résultats d'examens)<br><br>
  ...
  <table border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
      ...
      <td>&nbsp;<?php text("size='10' onkeyup='formate_date(this)'","depistageCancerUterus:date"); ?></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
