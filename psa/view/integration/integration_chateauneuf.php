<?php
function integration_chateauneuf($fichier, $fichier_name){

	$upfile="./log/chateauneuf/".$fichier_name;
...
if ($archive->extract(PCLZIP_OPT_PATH, "./log/chateauneuf/") == 0) {
...
$fichier="./log/chateauneuf/".$list[0]["filename"];
