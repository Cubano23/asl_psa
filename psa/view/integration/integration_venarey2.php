<?php
function integration_venarey2($fichier, $fichier_name){

	$upfile="./log/venarey2/".$fichier_name;
...
if ($archive->extract(PCLZIP_OPT_PATH, "./log/venarey2/") == 0) {
...
$fichier="./log/venarey2/".$list[0]["filename"];
