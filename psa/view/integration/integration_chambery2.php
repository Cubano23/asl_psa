			...
			if($recherche==1){//On est sur les résultat du labo
				...
				if($tab_ligne[0]=="RES"){
					...
					if(isset($mots[$exam])){//Il s'agit d'un exam à intégrer
						...
						if($id==""){//Le dossier n'est pas reconnu=> affichage dans le rapport d'erreur
							...
							else{//La donnée est déjà présente dans asalée
