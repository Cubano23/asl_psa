...
elseif($_GET["logiciel"]=="ict"){
	echo htmlentities("1.Créer la requête  Ouvrir ICT page d'accueil")."<br><br>".
	 htmlentities("Aller dans outils ( dernière icône à droite)")."<br>".
	 htmlentities("Dans le menu déroulant aller dans définition des statistiques puis gestion des requêtes.")."<br>".
	 htmlentities("Un nouveau cadre s'affiche : cliquer sur créer requête")."<br>".
	 htmlentities("Un nouveau carde s'affiche : Choisir un intitulé , ex :  extractions de données")."<br>".
	 htmlentities("Cliquer sur le PLUS en vert qui ouvre un nouveau cadre")."<br>".
	 htmlentities(". Dans l'opérande gauche choisir dans \"Dossier patient\", Constantes, puis toutes puis date de la mesure.")."<br>".
	 htmlentities(". Dans l'opérateur de comparaison choisir sup ou égal")."<br>".
	 htmlentities(". Dans l'opérande droit choisir valeur et cocher \" me demander de la saisir \" puis OK en bas à droite")."<br>".
	 htmlentities("Cliquer sur le PLUS en vert qui ouvre un nouveau cadre")."<br>".
	 htmlentities(". Dans l'opérande gauche choisir dans \" Dossier patient \", Constantes, puis toutes puis date de la mesure.")."<br>".
	 htmlentities(". Dans l'opérateur de comparaison choisir inf ou égal")."<br>".
	 htmlentities(". Dans l'opérande droit choisir valeur et cocher « me demander de la saisir » puis OK en bas à droite")."<br>".
	 htmlentities("La ligne supérieure s'affiche en rouge, cliquer dessus puis sur \" et \"")."<br>".
	 htmlentities("Cliquer sur le PLUS en vert qui ouvre un nouveau cadre")."<br>".
	 htmlentities(". Dans l'opérande gauche choisir patient, identité , âge .")."<br>".
	 htmlentities(". Dans l'opérateur de comparaison choisir sup ou égal")."<br>". 
	 htmlentities(". Dans l'opérande droit choisir valeur et cocher « me demander de la saisir » puis  cocher 16 ans")."<br>".
	 htmlentities("La ligne supérieure s'affiche en rouge, cliquer dessus puis sur \" et \"")."<br>".
	 htmlentities("Puis OK en bas à droite")."<br>".
	 htmlentities("Pour finir, retour au tableau avec les trois critères de recherche, cocher OK en bas à droite")."<br><b>".
	 htmlentities("Cette démarche n'est à faire qu'une seule fois")."</b><br>".
	 htmlentities("Fermer")."<br><br>".
	htmlentities("2.Créer  l'Etat : dans ICT page d'accueil")."<br><br>".
	htmlentities("Aller dans outils ( dernière icône à droite)")."<br>".
	htmlentities("Dans le menu déroulant aller dans définition des statistiques puis gestion des états.")."<br>".
	htmlentities("Un nouveau cadre s'affiche : cliquer sur créer état")."<br>".
	htmlentities("Un nouveau cadre s'affiche : Choisir un intitulé , pour simplifier, le même titre que la requête précédemment créée.")."<br>".
	htmlentities("Choisir dans le menu déroulant sous l'intitulé la requête correspondante.")."<br>".
	htmlentities("Dans la colonne de droite « champs accessibles »")."<br>". 
	htmlentities(". Cliquer sur flèche grise de dossier patient, puis sur celle « constante », puis sur celle de « toutes ».")."<br>".
	htmlentities(". Cliquer deux fois sur « date de la mesure », deux fois sur « valeur », deux fois sur «  Unité », deux fois sur « type » ")."<br>".
	htmlentities(". Ces données s'affichent sur la colonne de droite dans champs sélectionnés.")."<br>".
	htmlentities(". Double Cliquer sur «  Numéro ext » dans les champs accessibles à gauche ( en haut)")."<br>".
	htmlentities("En bas à droite sélectionner la destination , de préférence excel, puis cliquer sur lancer.")."<br>".
	htmlentities("Ict  demande l'enregistrement : OUI")."<br>".
	htmlentities("Un cadre s'ouvre «  saisie utilisateur » taper la date de début de la recherche puis valider,")."<br>".
	htmlentities("Le même cadre s'ouvre à nouveau et cocher « maintenant » ou la date de fin de la recherche")."<br>".
	htmlentities("ICT demande sous quel nom enregistrer le fichier (facilité prendre le nom de la semaine ; ex S5) et  où enregistrer le fichier ( ex créer un dossier extractions sur le bureau de l'ordinateur.")."<br><b>".
	htmlentities("Par la suite, il est seulement utile d'aller dans ICT, outils, gestions des états, choisir l'Etat concerné crée, puis de rentrer les dates souhaitées.")."</b><br><br>";
...
elseif($_GET["logiciel"]=="mediclic3" || $_GET["logiciel"]=="mediclic4"){
	echo htmlentities("1- Aller dans Mediclick / QuizzClick Studio")."<br><br>".
		 htmlentities("2- Aller dans l'onglet \"Dossier\". Sur la partie de gauche cliquer sur \"Divers\" puis double cliquer sur \"n° de dossier\". Une ligne n° de dossier doit apparaître sur le cadre principal de la page. Sur les valeurs min et max indiquer 0 et 10000")."<br><br>".
		 ...
		 htmlentities("8- Si vous souhaitez intégrer d'autres examens, cliquer sur l'icone poubelle de la ligne créée à l'étape 4, puis exécuter à nouveau les étapes 4, 5, 6, 7 en sélectionnant l'examen désiré au moment de faire l'étape 4")."<br><br>";
}
elseif($_GET["logiciel"]=="mediclic5"){
	echo htmlentities("1- Aller dans Mediclick / QuizzClick Studio")."<br><br>".
		 ...
		 htmlentities("3- Aller dans l'onglet \"Biologie\", catégorie : nom de l'examen, double cliquer sur l'examen cherché, par exemple « HBA1c », sur les valeurs min et max indiquer les valeurs extêmes possibles pouvant être prise par cette biologie")."<br><br>".
		 htmlentities("4- Dans la partie \"rubriques standard\", double cliquer sur date de l'examen. Pour date de l'examen indiquer un intervalle de date compris entre 2 semaines avant la date du jour et la date du jour. ")."<br><br>".
		 htmlentities("5- cliquer sur \"lancer la recherche\". La liste des examens trouvés apparait en bas de page")."<br><br>".
		 htmlentities("6- enregistrer le fichier en cliquant sur la disquette")."<br><br>".
		 htmlentities("7- Aller sur la page d'intégration automatiques de données et sélectionner le fichier créé à l'étape 6 puis cliquer sur intégrer")."<br><br>".
		 htmlentities("8- Si vous souhaitez intégrer d'autres examens, cliquer sur l'icone poubelle de la ligne créée à l'étape 4, puis exécuter à nouveau les étapes 4, 5, 6, 7 en sélectionnant l'examen désiré au moment de faire l'étape")."<br><br>";
}
