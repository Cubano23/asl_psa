...
<!--		    <tr>
		  ...
		  <tr> 
            ...
            <td>&nbsp;<?php echo stripslashes($depistageDiabete->note_gly); ?></td>
          </tr>
		  <?php }?>
-->	  <tr> 
...
<?php /*    <tr>
      <td> <input type='submit' value='Supprimer ce suivi' OnClick="return confirm('Voulez vous réellement supprimer cette réponse ?')"> </td> 
      <td> <input type='submit' value='Modifier ce suivi'>
 </td>
    </tr> */?>
