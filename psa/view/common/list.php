...
<table width="75%"  border="1" cellspacing="0" cellpadding="0">
  ...
  <CAPTION  ><?php echo(count($rowsList)); if(($currentObjectName=='depistageCancerSein')||($currentObjectName=='depistageCancerUterus'))
  												echo ' patientes trouvées';
											elseif(($currentObjectName=='depistageCancerColon')||($currentObjectName=='depistageDiabete'))
												echo ' patients trouvés';
											else echo ' enregistrements trouvés';?> </CAPTION>
 ...
 <?php /*   <th scope="col">&nbsp;Réponse</th>*/ ?>
  ...
  <tr>
    ...
    <td>&nbsp;<?php echo(mysqlDateTodate(getDoubleArrayElement($rowsList,$i,"dconsentement"))); ?></td>
<?php /*    <td>&nbsp;<?php echo(mysqlDateTodate(getDoubleArrayElement($rowsList,$i,"date"))); ?></td>*/?>
    <td>&nbsp;<?php
				 $additionalParams = array("Dossier:dossier:numero"=>getDoubleArrayElement($rowsList,$i,"numero"),
				 						   /*"controlerparams:param:controler=".$currentObjectClass."Controler"/*"$currentObjectClass:$currentObjectName:date"=>mysqlDateTodate(getDoubleArrayElement($rowsList,$i,"date"))*/);
