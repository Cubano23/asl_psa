...
//aI("text=Suivi Touaregs;url=../controler/ActionControler.php?controlerparams:param:controler=SuiviTouaregsControler&controlerparams:param:action=AM&controlerparams:param:param1=PPCREAT;");
...
aI("text=Suivi des r&eacute;unions de concertation m&eacute;decin ;url=../controler/ActionControler.php?controlerparams:param:controler=SuiviReunionMedecinControler&controlerparams:param:action=AM;");
...
aI("text=Suivi hebdo du temps pass&eacute;;url=../controler/ActionControler.php?controlerparams:param:controler=SuiviHebdomadaireTempsPasseControler&controlerparams:param:action=AL;");
