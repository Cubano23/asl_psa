...
<?php
	...
	$js->dateInRange("depistageCancerSein:date","Date du dépistage");
	$js->endCheckFunction();	
?>
</script>
...
Ce formulaire permet à tout instant de collecter des données utiles au protocole dépistage du cancer du sein.<br><br>
Il s'appuie sur les données les plus récentes du patient (résultats d'examens, antécédents)<br><br>
  ...
  <table border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
      ...
      <td>&nbsp; <?php text("size='10' onkeyup='formate_date(this)'","depistageCancerSein:date"); ?></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan='2'>
	  	<?php customSubmit("value='Créer un dépistage'",ACTION_NEW,"",""); ?>
