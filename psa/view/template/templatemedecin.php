...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th height="49" scope="col">&nbsp;
	 <a href="javascript:history.back()"> <img src="<?php echo $path; ?>/view/images/back.gif" alt="page précédente" border="0"></a>
	</th>
    <th scope="col"><span class="headerTitle">Asal&eacute;e</span></th>
    <th scope="col"><a href="javascript:window.close()"><img src="<?php echo $path; ?>/view/images/close.gif"  border=0 alt="fermer" width=13 height=12 alt="Fermer la fenêtre"></a>
