...
<body onload='select_id()' <?php
    if(($_SERVER['HTTP_HOST'] == 'psatest.asalee.fr') || ($_SERVER['HTTP_HOST'] == 'localhost') ){
                    ...
                    <!--778-->					<td width="901" valign="top" bgcolor="white">
                        <div class="connexe">
                            <div class="login">
                                ...
                                <!--								<h2>Veuillez rentrer votre nom d'utilisateur et votre mot de passexxxx.</h2>      -->
